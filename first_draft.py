...
master.geometry("1000x425+125+50")
...
# Carlos
altP, tP, d1, d2 = tk.IntVar(), tk.StringVar(), tk.IntVar(), tk.IntVar()
...
def clock():
    ...
    hTime = str(hour) + ":" + str(minute) + ":" + str(second)
    # if int(seg) < 10:
    #     num = minutos + " : 0" + seg
    # else:
    #     num = minutos + " : " + seg
...
def table(list):
    ...
    list = []  # Empty List created to store the actual time
